...
<div class="data-table-area mg-tb-15">
            <div class="container-fluid">
				...
				while($row=mysqli_fetch_array($school)){
					?>
                                            <tr>
												...
												<input type="password" name="opassword" required class="form-control" /></td>
                                                <td> <input type="password"  name="newpassword" required class="form-control" /></td>
                                                <td> <input type="password" name="snewpassword" required class="form-control" /></td>
				...
				<?php }?>
								...
								<br><br><p> <input type="submit" value="Change" name="submit" /></p>
