                    ...
                    <div class="row">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Google Map" href="viewmember.php"><i class="fa fa-book sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">View Members</span></a></li>
                                <li><a title="Data Maps" href="editmember.php"><i class="fa fa-cog sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Edit Members</span></a></li>
                                <li><a title="Pdf Viewer" href="memberdelete.php"><i class="fa fa-recycle sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Delete Members</span></a></li>
                            </ul>
                        </li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="tinymce-single responsive-mg-b-30">
                            <div class="alert-title">
							 ...
							 <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                                <label class="login2 ">Title</label><input type="text" class="form-control" name="name"/>
                                                            </div>
                                                          <br>
                                                          <br>
                                                          <br>
							...
							<br>
							 <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                                <label class="login2 ">File</label><input type="file" class="form-control" required name="file" />
                                                            </div>
                                                          
                                                        </div>
        
							<button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="save">Post</button>
